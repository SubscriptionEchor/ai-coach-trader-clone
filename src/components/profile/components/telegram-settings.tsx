...
import { MessageCircle, Check, Shield, ExternalLink } from 'lucide-react';
    ...
    >
      ...
      <div className="mt-6 pt-6 border-t border-white/10">
        ...
        <p className="mt-3 text-sm text-gray-400">
          Note: Join our official Telegram channel to receive real-time trading signals and updates if you not joined
        </p>
      </div>
    </motion.div>
  );
